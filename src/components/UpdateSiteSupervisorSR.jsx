...
export default function UpdateSiteSupervisorSR(props) {
  const supervisors = props.supervisors.filter((i) => i.position !== "jr");
          ...
          <Form>
            <Form.Group>
              ...
              <Form.Select
                ...
                onChange={(e) =>
                  setForm({ ...form, supervisor_sr: e.target.value })
                }
                required
              >
